...
>
        ...
        >
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            {/* CTA - Emas dihilangkan, diganti gaya editorial monokrom */}
            <Link
              href={primaryCtaHref}
            ...
            >
              ...
              <div className="absolute inset-0 -z-0 scale-x-0 bg-white opacity-0 transition-all duration-500 origin-left group-hover:scale-x-100 group-hover:opacity-100 border border-slate-200 rounded-full" />
            </Link>
          </div>
