  ...
  return (
    <main>
      ...
      <section className="hero-section relative mx-4 my-4 flex min-h-[calc(100vh-2rem)] flex-col overflow-hidden rounded-[28px] bg-[#020617] md:mx-6 lg:mx-8">
        ...
        {/* ═══ MAIN CONTENT GRID ═══ */}
        <div className="relative z-10 mx-auto grid w-full max-w-[1400px] flex-1 grid-cols-1 items-center gap-16 px-[6%] py-20 lg:grid-cols-[0.92fr_1.08fr] lg:gap-10 lg:py-0">
          {/* ── LEFT COLUMN ── */}
          <div className="max-w-2xl">
            ...
            {/* Main heading */}
            <h1 className="mb-10 max-w-4xl font-heading text-[clamp(3rem,6vw,6.5rem)] font-light leading-[1.05] tracking-[-0.01em] text-white">
          ...
          {/* ══════════════════════════════════════════════════════════
              RIGHT COLUMN: Dynamic Featured Project Carousel
              ══════════════════════════════════════════════════════════ */}
          {featuredProjects.length ? (
            <HeroProjectCarousel projects={featuredProjects} />
          ) : null}
        </div>
